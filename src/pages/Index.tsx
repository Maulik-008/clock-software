  ...
  return (
    <>
      ...
      <PageLayout>
        ...
        <main
          className={`relative z-10 min-h-screen flex items-center justify-center p-3 sm:p-4 ${isFullView ? "pt-4" : "pt-16 sm:pt-18 md:pt-20"}`}
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-8">
              <div className="bg-black/50 backdrop-blur-lg rounded-xl border border-cyan-900/50 p-5 flex flex-col items-center">
                ...
                <p className="text-gray-300 text-center mb-4">
                  Track your study sessions with our aesthetic timer app.
                  Perfect for "study with me" sessions and continuous focus time
                  tracking.
                </p>
                <Link
                  to="/study-timer"
          ...
          <section className="relative z-10 py-8 px-4 max-w-4xl mx-auto text-gray-200">
            <div className="bg-black/60 backdrop-blur-xl p-5 sm:p-8 rounded-xl border border-gray-800 shadow-xl">
              <h2 className="text-2xl sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-pink-500 mb-4">
                StudyClock.com – Best Study & Productivity Timer | Pomodoro,
                Task Tracking & Focus Toolsmote Work
              </h2>
              ...
              <div className="space-y-6 text-base sm:text-lg">
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    dedicated partner for academic and professional success.
                    This modern, distraction-free time management tool helps
                    students, professionals, and creatives stay focused,
                    productive, and organized. With its elegant dark mode
                    interface and versatile timer options (including Pomodoro,
                    Clock, and Countdown), StudyClock.com empowers you to
                    structure your work effectively, whether you're studying for
                    exams, coding an assignment, writing papers, or working
                    remotely.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    scientifically-backed strategies like the Pomodoro
                    Technique, breaking down daunting tasks into manageable,
                    focused intervals. By alternating intense work bursts with
                    strategic short breaks, StudyClock.com helps you absorb
                    information more effectively, maintain peak concentration,
                    and prevent the burnout that can derail your goals. This
                    technique is proven to reduce mental fatigue, boost
                    concentration, and increase task completion rates. Stop
                    cramming, start working smarter.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 text-gray-300 space-y-2">
                    ...
                    <li>
                      ...
                      Use our beautiful visual themes and subtle effects to
                      create an environment that enhances your concentration.
                    </li>
                    <li>
                      <span className="text-white font-medium">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-3">
                    ...
                    <div className="flex items-start space-x-2">
                      ...
                      <div>
                        ...
                        <p className="text-gray-400">
                          Reduce eye strain during late-night work marathons
                          with our dynamic and beautiful color schemes.
                        </p>
                      </div>
                    </div>
