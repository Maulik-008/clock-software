  ...
  return (
    <>
      ...
      <PageLayout>
        ...
        <main
          className={`mt-4 relative z-10 min-h-screen flex items-center justify-center p-3 sm:p-4 ${isFullView ? "pt-4" : "pt-28 sm:pt-28 md:pt-28"}`}
        >
              ...
              <div className="space-y-6 text-base sm:text-lg">
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    Unlike open-ended work sessions, our countdown timer creates
                    a clear finish line that motivates your brain to enter a
                    state of enhanced focus, helping you accomplish more in less
                    time.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 text-gray-300 space-y-2">
                    ...
                    <li>
                      ...
                      Color changes and animations that subtly indicate when
                      time is running low.
                    </li>
                    <li>
                      <span className="text-white font-medium">
                      ...
                      Perfect for scheduling short breaks between intensive
                      study sessions.
                    </li>
                    <li>
                      <span className="text-white font-medium">
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Countdown timers are proven to enhance productivity through
                    a psychological principle called "Parkinson's Law" - work
                    expands to fill the time available for its completion. By
                    setting defined time limits, you naturally become more
                    efficient. Our timer also helps combat the "Zeigarnik
                    Effect" - the tendency for uncompleted tasks to cause mental
                    tension. The clear endpoint provided by the countdown timer
                    gives your brain permission to fully engage with the task at
                    hand.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    simulate test conditions. Practice answering questions
                    within specific time constraints to build your time
                    management skills for the actual exam. This technique helps
                    reduce test anxiety by making you comfortable with timed
                    pressure and teaches you to allocate appropriate time to
                    different sections of an exam.
                  </p>
                </div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                      ...
                      <p className="text-gray-300 mt-2">
                        Unlike a regular clock that simply shows the current
                        time, a countdown timer creates a sense of structure and
                        urgency by displaying the decreasing amount of time left
                        for a task. This visual countdown helps your brain focus
                        and prioritize completing the task before time runs out,
                    ...
                    <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                      ...
                      <p className="text-gray-300 mt-2">
                        ...
                        focused study sessions. However, this varies by
                        individual and task type. For complex material, shorter
                        20-30 minute sessions may be more effective. For tasks
                        requiring deep thought, 40-50 minutes might work better.
                        Our timer allows you to customize these intervals based
                        on your personal concentration patterns.
                      </p>
                    </div>
                    ...
                    <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                      ...
                      <p className="text-gray-300 mt-2">
                        ...
                        large tasks. Our countdown timer helps you break work
                        into manageable chunks, making it easier to start. The
                        time constraint also creates a sense of manageable
                        urgency that motivates action. Many users find that
                        setting a short 10-minute timer helps overcome initial
                        resistance to starting difficult tasks.
                      </p>
                    </div>
                    ...
                    <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                      ...
                      <p className="text-gray-300 mt-2">
                        ...
                        accidentally extend too long, keeping your study
                        schedule on track while still giving your mind the rest
                        it needs.
                      </p>
                    </div>
                    ...
                    <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                      ...
                      <p className="text-gray-300 mt-2">
                        ...
                        physical timers: visual themes that create a more
                        pleasant study environment, seamless integration with
                        your digital workspace, clear visual and audio alerts,
                        and the convenience of always having it available on
                        your device. The aesthetic design also makes it more
                        enjoyable to use, increasing the likelihood you'll stick
                        with your time management system.
                      </p>
                    </div>
                    ...
                    <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                      ...
                      <p className="text-gray-300 mt-2">
                        ...
                        ensures you're notified even if you're not looking at
                        the screen, while browser notifications appear on your
                        device even if you're in another tab or application. You
                        can easily customize your notification preferences by
                        toggling sound and notifications on or off using the
                        control buttons on the timer interface.
                      </p>
                    </div>
                  </div>
                </div>
