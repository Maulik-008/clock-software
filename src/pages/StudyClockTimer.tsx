...
const StudyClockTimer = () => {
  ...
  const { time, isRunning, start, pause, reset } =
    usePersistedTimer("study-clock-timer");
  ...
  return (
    <>
      ...
      <PageLayout>
        ...
        {/* Main Content */}
        <main
          className={`relative z-10 min-h-screen flex flex-col items-center justify-center p-3 sm:p-4 ${
            isFullView ? "pt-4" : "pt-28 sm:pt-28 md:pt-28"
          }`}
        >
              ...
              {!isFullView && (
                <>
                  <div className="mt-6 text-center text-gray-400 text-sm max-w-md mx-auto">
                    <p>
                      The Study Clock Timer helps you track focused study
                      sessions with a beautiful, distraction-free interface.
                      Choose your preferred style and start tracking your
                      productivity.
                    </p>
                  </div>
                </>
              ...
              <div className="space-y-6 text-base sm:text-lg">
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Are you tired of looking at your mobile phone every 5
                    minutes to check the time during studies? Well, we've all
                    been there! That's exactly why our Study Clock Timer is a
                    game-changer for students across India and beyond. It's not
                    just any ordinary timer clock - it's specially designed to
                    enhance your study experience with its beautiful interface
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    ...
                    psychological commitment to your study session. When you
                    start the Study Clock Timer, your brain registers that
                    "study mode" has begun. The visual countdown creates a
                    gentle pressure that keeps you accountable and focused on
                    your books instead of social media.
                  </p>
                  <p className="text-gray-300 leading-relaxed mt-2">
                    ...
                    glance, so you can check your progress without breaking
                    focus.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 text-gray-300 space-y-3">
                    <li>
                      ...
                      Unlike boring digital timers, our study clock timer
                      features a gorgeous analog-style design that's easy on the
                      eyes during long study sessions. No more eye strain from
                      harsh displays!
                    </li>
                    <li>
                      <span className="text-white font-medium">
                    ...
                    <li>
                      ...
                      discover how their perceived study time differs from
                      actual time spent!
                    </li>
                    <li>
                      <span className="text-white font-medium">
                      ...
                      Enable sound notifications if you prefer auditory cues
                      when controlling the timer. Perfect for those who like
                      gentle reminders.
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    The ideal study environment combines several elements -
                    proper lighting, a comfortable seat, good study materials,
                    and importantly, a reliable timer for study sessions. Our
                    timer clock helps create structure in your study routine,
                    which is especially valuable for students preparing for
                    competitive exams.
                  </p>
                  <p className="text-gray-300 leading-relaxed mt-2">
                ...
                <div>
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    Whether you follow the traditional continuous study method
                    or modern techniques like active recall or spaced
                    repetition, our timer clock adapts perfectly to your
                    approach. Many students use it alongside their favorite
                    study method:
                  </p>
                  ...
                  <div className="space-y-4">
                    <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                      <h4 className="font-medium text-white text-lg">
                        How is a study clock timer different from a regular
                        timer?
                      </h4>
                      <p className="text-gray-300 mt-2">
                        Unlike regular timers, our study clock timer is
                        specially designed with students in mind. It features a
                        distraction-free interface, visual styles that reduce
                        eye strain during long study sessions, and a
                        psychological design that encourages focus. Regular
                        timers often have basic functionality, but our timer for
                        study creates an environment conducive to learning and
                        concentration.
                      </p>
                    </div>
                    ...
                    <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                      ...
                      <p className="text-gray-300 mt-2">
                        ...
                        recommend starting with 30-45 minute focused sessions.
                        If you're just beginning, even 20-minute sessions with
                        short breaks can be effective. The key is consistency!
                        Our timer clock allows you to track your progress and
                        gradually increase your focus duration as your
                        concentration improves. Many successful students in
                        India practice the "2-hour rule" - studying intensely
                        for 2 hours, followed by a 15-minute break.
                      </p>
                    </div>
                    ...
                    <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                      ...
                      <p className="text-gray-300 mt-2">
                        ...
                        helps you understand how long different types of
                        questions take. Many coaching institutes across India
                        recommend using a study timer to build exam temperament.
                        As they say, "Practice like you play!"
                      </p>
                    </div>
                    ...
                    <div className="bg-black/40 rounded-lg p-4 border border-gray-800">
                      ...
                      <p className="text-gray-300 mt-2">
                        Parents can use our timer clock to create structured
                        study routines for their children. Starting with shorter
                        ...
                        disruptive. It's a wonderful tool to teach time
                        management - a skill that will benefit children
                ...
                <div className="pt-4">
                  ...
                  <p className="text-center text-gray-300">
                    ...
                    academic success. Remember, toppers aren't just born -
                    they're made through disciplined study habits!
                  </p>
                </div>
              </div>
            </div>
