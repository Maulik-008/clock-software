...
const ClockTimer = () => {
  ...
  const [clockStyle, setClockStyle] = useState('neon');
    ...
    switch (clockStyle) {
      case 'matrix':
        return {
          ...
          title: 'text-green-400 tracking-[0.4em] font-mono text-xl sm:text-2xl md:text-3xl',
          timeText: 'text-transparent bg-clip-text bg-gradient-to-b from-green-400 to-lime-600 font-mono',
      ...
      case 'hologram':
        return {
          ...
          title: 'text-blue-300 tracking-[0.3em] font-light text-xl sm:text-2xl md:text-3xl',
          timeText: 'text-transparent bg-clip-text bg-gradient-to-b from-blue-300 to-indigo-500',
      ...
      case 'cyberpunk':
        return {
          ...
          title: 'text-pink-400 tracking-[0.4em] font-bold text-xl sm:text-2xl md:text-3xl',
          timeText: 'text-transparent bg-clip-text bg-gradient-to-b from-pink-400 to-purple-600',
      ...
      case 'quantum':
        return {
          ...
          title: 'text-emerald-400 tracking-[0.4em] font-medium text-xl sm:text-2xl md:text-3xl',
          timeText: 'text-transparent bg-clip-text bg-gradient-to-b from-emerald-400 to-green-600',
      ...
      case 'plasma':
        return {
          ...
          title: 'text-orange-400 tracking-[0.4em] font-bold text-xl sm:text-2xl md:text-3xl',
          timeText: 'text-transparent bg-clip-text bg-gradient-to-b from-orange-400 to-red-600',
      ...
      case 'cosmic':
        return {
          ...
          title: 'text-violet-400 tracking-[0.4em] font-light text-xl sm:text-2xl md:text-3xl',
          timeText: 'text-transparent bg-clip-text bg-gradient-to-b from-violet-400 to-purple-600',
      ...
      case 'aurora':
        return {
          ...
          title: 'text-teal-400 tracking-[0.4em] font-light text-xl sm:text-2xl md:text-3xl',
          timeText: 'text-transparent bg-clip-text bg-gradient-to-b from-teal-400 to-cyan-600',
      ...
      default: // neon
        return {
          container: 'backdrop-blur-2xl bg-slate-950/90 border border-cyan-500/40 shadow-2xl shadow-cyan-500/30',
          glow: 'bg-gradient-to-r from-cyan-500/30 via-blue-500/30 to-purple-500/30',
          title: 'text-cyan-300 tracking-[0.3em] text-xl sm:text-2xl md:text-3xl',
          timeText: 'text-transparent bg-clip-text bg-gradient-to-b from-cyan-400 to-blue-600',
        ...
        <div className="relative z-10 text-center">
          ...
          <div className="flex justify-center mb-6 sm:mb-8">
            <button
              ...
              className="px-4 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl bg-black/50 border border-white/20 text-white/90 text-xs sm:text-sm hover:bg-white/10 transition-all duration-500 hover:scale-110 hover:shadow-2xl hover:shadow-cyan-500/20 backdrop-blur-xl"
            >
          ...
          <div className="mb-8 sm:mb-10">
            <div className="flex items-center justify-center space-x-2 sm:space-x-3 text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-mono font-bold">
              ...
              <div className="relative group">
                <div className={`drop-shadow-2xl transform transition-all duration-500 hover:scale-110 ${styles.timeText} ${isRunning ? 'animate-pulse' : ''}`}>
                  {timeDisplay.hours}
                </div>
                <div className={`absolute inset-0 blur-lg animate-pulse ${styles.timeGlow}`}>
                  {timeDisplay.hours}
                </div>
                <div className={`absolute inset-0 blur-2xl opacity-50 ${styles.timeGlow}`}>
                  {timeDisplay.hours}
                </div>
              </div>

              {/* Enhanced Colon */}
              <div className={`transition-all duration-300 transform ${isRunning ? 'animate-pulse scale-110' : 'scale-100'} ${styles.colon}`}>
                :
              </div>
              ...
              {!format24h && timeDisplay.ampm && (
                <div className={`text-sm sm:text-base md:text-lg ml-2 sm:ml-3 self-start mt-2 sm:mt-3 opacity-80 ${styles.colon}`}>
                  {timeDisplay.ampm}
                </div>
              )}
            </div>
