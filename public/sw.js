...
// Note: Custom alarm audio files uploaded by users are stored in IndexedDB
// (not in service worker cache) and are automatically available offline.
// Only predefined alarms need to be cached by the service worker.
